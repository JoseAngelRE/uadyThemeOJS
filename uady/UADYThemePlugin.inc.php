...
/**
 * @file plugins/themes/uady/uadyThemePlugin.inc.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2003-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class uadyThemePlugin
 * @ingroup plugins_themes_uady
 *
 * @brief uady theme
 */
...
class UADYThemePlugin extends ThemePlugin {
	/**
	...
	public function init() {
		...
		$this->addOption('typography', 'FieldOptions', [
			'type' => 'radio',
			'label' => __('plugins.themes.uady.option.typography.label'),
			'description' => __('plugins.themes.uady.option.typography.description'),
			'options' => [
				[
					'value' => 'notoSans',
					'label' => __('plugins.themes.uady.option.typography.notoSans'),
				],
				[
					'value' => 'notoSerif',
					'label' => __('plugins.themes.uady.option.typography.notoSerif'),
				],
				[
					'value' => 'notoSerif_notoSans',
					'label' => __('plugins.themes.uady.option.typography.notoSerif_notoSans'),
				],
				[
					'value' => 'notoSans_notoSerif',
					'label' => __('plugins.themes.uady.option.typography.notoSans_notoSerif'),
				],
				[
					'value' => 'lato',
					'label' => __('plugins.themes.uady.option.typography.lato'),
				],
				[
					'value' => 'lora',
					'label' => __('plugins.themes.uady.option.typography.lora'),
				],
				[
					'value' => 'lora_openSans',
					'label' => __('plugins.themes.uady.option.typography.lora_openSans'),
				],
			],
			'uady' => 'notoSans',
		]);
		...
		$this->addOption('baseColour', 'FieldColor', [
			'label' => __('plugins.themes.uady.option.colour.label'),
			'description' => __('plugins.themes.uady.option.colour.description'),
			'uady' => '#1E6292',
		]);
		...
		$this->addOption('showDescriptionInJournalIndex', 'FieldOptions', [
			'label' => __('manager.setup.contextSummary'),
				...
				[
					'value' => true,
					'label' => __('plugins.themes.uady.option.showDescriptionInJournalIndex.option'),
				],
			],
			'uady' => false,
		]);
		$this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
			'label' => __('plugins.themes.uady.option.useHomepageImageAsHeader.label'),
			'description' => __('plugins.themes.uady.option.useHomepageImageAsHeader.description'),
				'options' => [
				[
					'value' => true,
					'label' => __('plugins.themes.uady.option.useHomepageImageAsHeader.option')
				],
			],
			'uady' => false,
		]);
		...
		$this->addScript('uady', 'js/main.js');
	...
	function getDisplayName() {
		return __('plugins.themes.uady.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.uady.description');
	}
}
